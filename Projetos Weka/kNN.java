...
public class kNN 
{
    public static void main(String[] args) 
    {
        try
        {
            ...
            IBk kNN = new IBk(3); // Instância do kNN com K = 3, poderia ser qualquer valor aqui
            
            kNN.buildClassifier(ins); // Faz o classificador estudar as instâncias
            
            double classe = kNN.classifyInstance(in); // Classifica a instância que criamos
